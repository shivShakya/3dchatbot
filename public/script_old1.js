...
function speechToText(callback) {
    ...
    let hasSpoken = false; // Flag to ensure the action is executed only once
    ...
    recognition.onend = () => {
      ...
      hasSpoken = false; // Reset the flag when speech ends
      //recognition.start();
    };
    ...
    queue = queue.then(async () => {
        ...
        try {
            ...
            if (data.audio_base64) { 
                wordsWithTiming = wordsWithTimingAndPhonemes(alignment);
